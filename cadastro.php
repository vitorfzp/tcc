...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="login.html" class="menu-item active" title="Login"><svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M11 7L9.6 8.4l2.6 2.6H2v2h10.2l-2.6 2.6L11 17l5-5-5-5zm9 12h-8v-2h8v2zm0-4h-8v-2h8v2zm0-4h-8V9h8v2z"/></svg><span>Login / Cadastro</span></a>
        </nav>
    </aside>
    ...
    <main class="main-content">
        <section class="main-section form-container">
            ...
            <p>Preencha o formulário abaixo para se tornar um prestador de serviços na nossa plataforma.</p>
            <form class="custom-form" action="php/processar.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="arquivo">Anexar currículo/documento (Opcional)</label>
                ...
                <button type="submit" class="custom-button">Enviar Cadastro</button>
            </form>
             <p class="view-all">
                <a href="php/lista.php">Ver todos os cadastros</a>
             </p>
        </section>
    </main>
